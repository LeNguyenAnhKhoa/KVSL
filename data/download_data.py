...
chrome_driver_url = "https://storage.googleapis.com/chrome-for-testing-public/140.0.7339.128/win64/chromedriver-win64.zip"
...
def download_video(video_data):
    ...
    try:
        ...
        # Add SSL verification bypass for requests
...
def crawl_videos():
    ...
    # Add Chrome options to bypass SSL warnings
    options.add_argument('--disable-web-security')
    options.add_argument('--allow-running-insecure-content')
    options.add_argument('--disable-extensions')
    options.add_argument('--ignore-certificate-errors-spki-list')
    options.add_argument('--ignore-certificate-errors')
    options.add_argument('--ignore-ssl-errors-on-localhost')
    options.add_argument('--allow-running-insecure-content')
    ...
    # Optional: Run headless to avoid seeing the warnings
    ...
    try:
        ...
        # Wait a bit longer for the page to load with SSL issues
